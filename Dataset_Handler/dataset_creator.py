...
class DatasetCreator:
    ...
    def create_dataset():
        ...
        all_dataset = [surprise_dataset, happiness_dataset, sadness_dataset, disgust_dataset, anger_dataset, fear_dataset, neutral_dataset]
        for index, category in zip(range(len(all_dataset)), all_dataset):
            ...
            for index2, item in zip(range(len(category)),category):
                ...
                copyfile(item, "C:/Users/Ziadkamal/Desktop/Senior-2/Image Processing/Project/CreatedDataset7/"+str(index)+"_"+str(index2)+".jpg")
